...
INSERT INTO `tbl_book`(`id`, `type`, `name`, `description`) VALUES (3, '计算机理论', 'Spring 5 设计模式', '深入Spring源码剖析Spring源码中蕴含的10大设计模式');
...
INSERT INTO `tbl_book`(`id`, `type`, `name`, `description`) VALUES (6, '计算机理论', 'Java核心技术 卷l 基础知识（原书第11版）', 'Core Java 第11版，Jolt大奖获奖作品，针对Java SE9、10、11全面更新');
INSERT INTO `tbl_book`(`id`, `type`, `name`, `description`) VALUES (7, '计算机理论', '深入理解Java虚拟机', '5个维度全面剖析JVM，大厂面试知识点全覆盖');
